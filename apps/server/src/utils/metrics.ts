...
export const ordersPlaced = new client.Counter({
    name: "monex_orders_placed_total",
...
export const tradesExecuted = new client.Counter({
    name: "monex_trades_executed_total",
...
export const wsConnections = new client.Gauge({
    name: "monex_ws_connections_active",
    help: "Active WebSocket connections",
    registers: [register],
});

export const httpRequestDuration = new client.Histogram({
    name: "monex_http_request_duration_ms",
